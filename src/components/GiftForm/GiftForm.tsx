...
export const GiftForm = ({ addGift }: Props) => {
  ...
  return (
    <form className="w-[350px] flex flex-col gap-4" onSubmit={handleName}>
      ...
      <div className="w-full flex flex-row gap-4">
        ...
        <div className="w-16">
          <input
            className="w-full rounded-md border-gray-200 shadow-sm sm:text-sm outline-0"
            type="number"
            value={quantity}
